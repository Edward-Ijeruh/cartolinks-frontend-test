    ...
    <header className="w-full bg-white dark:bg-neutral-900 dark:border-neutral-800">
      <div className="flex items-center justify-between px-4 md:px-6 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium hidden sm:block">benevolentimibbet</span>
          <ChevronDown size={16} className="text-gray-500" />
        </div>

        {/* Center */}
        <nav className="hidden md:flex flex-1 justify-center">
          <div className="flex items-center gap-2 px-3 py-1 rounded-xl bg-gray-100 dark:bg-neutral-800 overflow-x-auto">
            {[
